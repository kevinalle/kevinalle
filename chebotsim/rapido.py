descripcion="""
<chebot tamanio="7.5" color="200,0,0">
	<habilidades>
...
def comportamiento(self):
	...
	TIMER_GIRO_INICIAL=100
	TIMER_ESCAPE_LINEA=40
	TIMER_GIRO_ESCAPE=70
	TIMER_SCAN_LOCAL=70
	...
	VELOCIDAD_GIRO_INICIAL=25
	VELOCIDAD_ESCAPE_LINEA=70
	VELOCIDAD_GIRO_ESCAPE=20
	VELOCIDAD_SCAN_GLOBAL_IZQ=-39
	VELOCIDAD_SCAN_GLOBAL_DER=-40
	VELOCIDAD_ATTACK=20
